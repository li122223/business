package com.zhuangjiayu.demo.controller;


import com.zhuangjiayu.demo.biz.ClaimVoucherBiz;
import com.zhuangjiayu.demo.dto.ClaimVoucherInfo;
...
public class ClaimVoucherController {
    ...
    public String update(HttpSession session, ClaimVoucherInfo info){
        Employee employee = (Employee)session.getAttribute("employee");
        if(employee.getSn()!=null&&info.getClaimVoucher()!=null&&info.getItems()!=null){
        info.getClaimVoucher().setCreateSn(employee.getSn());
