...
import com.zhuangjiayu.demo.biz.ClaimVoucherBiz;
import com.zhuangjiayu.demo.dao.ClaimVoucherDao;
import com.zhuangjiayu.demo.dao.ClaimVoucherItemDao;
import com.zhuangjiayu.demo.dao.DealRecordDao;
...
import com.zhuangjiayu.demo.global.Contant;
...
public class ClaimVoucherBizImpl implements ClaimVoucherBiz {
    ...
    public void update(ClaimVoucher claimVoucher, List<ClaimVoucherItem> items) {
        ...
        for(ClaimVoucherItem item:items) {
            if (claimVoucher.getId() != null&&item.getId()!=null) {
                item.setClaimVoucherId(claimVoucher.getId());
                if (item.getId() > 0) {
